...
class hobby(models.Model):
   ...
   hobby1=models.CharField(max_length=20, choices=[('スポーツ','スポーツ'),('読書','読書'),('旅行','旅行'),('カメラ','カメラ'),('ドラマ','ドラマ'),('映画','映画'),('ジャニーズ','ジャニーズ'),('アニメ','アニメ'),('漫画','漫画'),('料理','料理'),('お笑い','お笑い'),('K-POP','K-POP'),('ドライブ','ドライブ'),('ゲーム','ゲーム')])
   
   hobby2=models.CharField(max_length=20, choices=[('スポーツ','スポーツ'),('読書','読書'),('旅行','旅行'),('カメラ','カメラ'),('ドラマ','ドラマ'),('映画','映画'),('ジャニーズ','ジャニーズ'),('アニメ','アニメ'),('漫画','漫画'),('料理','料理'),('お笑い','お笑い'),('K-POP','K-POP'),('ドライブ','ドライブ'),('ゲーム','ゲーム')])
                           
   hobby3=models.CharField(max_length=20, choices=[('スポーツ','スポーツ'),('読書','読書'),('旅行','旅行'),('カメラ','カメラ'),('ドラマ','ドラマ'),('映画','映画'),('ジャニーズ','ジャニーズ'),('アニメ','アニメ'),('漫画','漫画'),('料理','料理'),('お笑い','お笑い'),('K-POP','K-POP'),('ドライブ','ドライブ'),('ゲーム','ゲーム')])
